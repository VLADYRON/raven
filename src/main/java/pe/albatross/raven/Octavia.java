package pe.albatross.raven;

import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.BETWEEN;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.BETWEEN_NOT;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.BLOCK_AND;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.BLOCK_OR;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.COMPLEX;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.COMPLEX_LIKE;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.EXISTS;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.IN_LIST;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.IN_LIST_DATES;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.IN_QUERY;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.IS_NOT_NULL;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.IS_NULL;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.LIKE;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.NOT_EXISTS;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.NOT_IN_LIST;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.NOT_IN_LIST_DATES;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.NOT_IN_QUERY;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.NOT_LIKE;
import static pe.albatross.raven.helpers.FilterQuery.FilterTypeEnum.OTHER_CONDITION;
...
import pe.albatross.raven.enums.ComparisonOperatorEnum;
import pe.albatross.raven.exceptions.OctaviaException;
import pe.albatross.raven.helpers.FilterQuery;
import pe.albatross.raven.helpers.ItemOrderBy;
import pe.albatross.raven.helpers.ItemOrderBy.OrderTypeEnum;
import pe.albatross.raven.helpers.ObjectHelper;
import pe.albatross.raven.helpers.Preconditions;
import pe.albatross.raven.helpers.TableQuery;
import pe.albatross.raven.helpers.TableQuery.TypeJoinEnum;
...
public class Octavia {
    ...
    public Integer execute(EntityManager session) {
    ...
    public Object find(EntityManager session) {
        query = session.createQuery(toString());
        setValues(filters);
        if (firstResult != null) {
    ...
    public List all(EntityManager session) {
        query = session.createQuery(toString());
        setValues(filters);
        if (firstResult != null) {
            query.setFirstResult(firstResult);
    ...
    private void setValue(FilterQuery filter) {
        ...
        if (value == null) {
            ...
            query.setParameter(param, (String) value);

        } else if (value instanceof Integer) {
            query.setParameter(param, (Integer) value);

        } else if (value instanceof Long) {
            query.setParameter(param, (Long) value);

        } else if (value instanceof BigDecimal) {
            query.setParameter(param, (BigDecimal) value);

        } else if (value instanceof Float) {
            query.setParameter(param, (Float) value);

        } else if (value instanceof Double) {
            query.setParameter(param, (Double) value);

        } else if (value instanceof Boolean) {
            query.setParameter(param, (Boolean) value);
            ...
            query.setParameter(param, getIdObject(value));
        }
    }
    ...
    private void setTwoValues(FilterQuery filter) {
        ...
        if (valueTwo instanceof String) {
            query.setParameter(paramTwo, (String) valueTwo);
        } else if (valueTwo instanceof Integer) {
            query.setParameter(paramTwo, (Integer) valueTwo);
        } else if (valueTwo instanceof Long) {
            query.setParameter(paramTwo, (Long) valueTwo);
        } else if (valueTwo instanceof BigDecimal) {
            query.setParameter(paramTwo, (BigDecimal) valueTwo);
        } else if (valueTwo instanceof Float) {
            query.setParameter(paramTwo, (Float) valueTwo);
        } else if (valueTwo instanceof Double) {
            query.setParameter(paramTwo, (Double) valueTwo);
        } else if (valueTwo instanceof Boolean) {
            query.setParameter(paramTwo, (Boolean) valueTwo);
        } else if (valueTwo instanceof Timestamp) {
            query.setParameter(paramTwo, (Timestamp) valueTwo);
        } else if (valueTwo instanceof Date) {
            query.setParameter(paramTwo, (Date) valueTwo);
        } else {
            query.setParameter(paramTwo, getIdObject(valueTwo));
        }
